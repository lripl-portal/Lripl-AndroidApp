...
public class ParentFirebaseMessagingService extends FirebaseMessagingService {
    private static final String TAG = ParentFirebaseMessagingService.class.getName();

    @Override
    public void onNewToken(String s) {
        Log.d(TAG + "-------------FCM_TOKEN", s);
        SharedPrefsHelper.getInstance(this).put(Constants.PREF_KEYS.DEVICE_TOKEN.name(), s);
    }
    ...
    private void sendNotification(String messageBody) {
        ...
        int requestCode = ("LRIPL" + System.currentTimeMillis()).hashCode();
